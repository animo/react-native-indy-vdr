...
class IndyVdr {
  ...
  private promisifyWithResponse = (method: (cb: (...args: any[]) => void) => void): Promise<string> => {
    return new Promise((resolve, reject) => {
  ...
  public buildGetAcceptanceMechanismsRequest(options: { timestamp?: Date; submitterDid?: string; version?: string }) {
  ...
  public buildCredDefRequest(options: { submitterDid: string; credDef: Record<string, unknown> }) {
    const { credDef, submitterDid } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildGetCredDefRequest(options: { submitterDid?: string; credDefId: string }) {
    const { submitterDid, credDefId } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildGetRevocRegDefRequest(options: { submitterDid?: string; revocRegId: string }) {
    const { revocRegId, submitterDid } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildGetRevocRegRequest(options: { submitterDid?: string; revocRegId: string; timestamp: Date }) {
    const { submitterDid, timestamp, revocRegId } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildGetRevocRegDeltaRequest(options: {
    ...
    const { submitterDid, revocRegId, fromTs, toTs } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildRevocRegDefRequest(options: { submitterDid?: string; revocRegId: string }) {
    const { submitterDid, revocRegId } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildCustomRequest(options: { requestJson: Record<string, unknown> }) {
    const { requestJson } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildDisableAllTxnAuthorAgreementsRequest(options: { submitterDid: string }) {
  ...
  public buildGetSchemaRequest(options: { submitterDid?: string; schemaId: string }) {
  ...
  public buildGetTxnAuthorAgreementRequest(options: { submitterDid?: string; data?: string }) {
  ...
  public buildGetTxnRequest(options: { submitterDid?: string; ledgerType: number; seqNo: number }) {
  ...
  public buildGetValidatorInfoRequest(options: { submitterDid: string; seqNo: number }) {
    const { submitterDid } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildRevocRegEntryRequest(options: {
    ...
    const { submitterDid, revocRegEntry, revocRegDefType, revocRegDefId } = serializeArguments(
      options
  ...
  public buildSchemaRequest(options: { submitterDid: string; schema: Record<string, unknown> }) {
  ...
  public buildRichSchemaRequest(options: {
    ...
    const { submitterDid, ver, rsType, rsVersion, rsName, rsContent, rsId } = serializeArguments(
      options
    ) as SerializedOptions<typeof options>
  ...
  public buildGetRichSchemaObjectByIdRequest(options: { submitterDid: string; rsId: string }) {
    const { submitterDid, rsId } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public buildGetRichSchemaObjectByMetadataRequest(options: {
    ...
    const { submitterDid, rsVersion, rsName, rsType } = serializeArguments(options) as SerializedOptions<typeof options>

    this.handle = NativeIndyVdr.build_get_rich_schema_object_by_metadata_request({
      submitter_did: submitterDid,
      rs_name: rsName,
      rs_type: rsType,
      rs_version: rsVersion,
  ...
  public poolCreate(options: { params: Record<string, unknown> }) {
    const { params } = serializeArguments(options) as SerializedOptions<typeof options>
  ...
  public requestSetTxnAuthorAgreementAcceptance(options: { acceptance: string }) {
