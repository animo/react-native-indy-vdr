...
// TODO: This is not generated. Is this the correct value?
...
ErrorCode indy_vdr_build_attrib_request(FfiStr submitter_did, FfiStr target_did,
                                        FfiStr hash, FfiStr raw, FfiStr enc,
                                        uintptr_t *handle_p);

ErrorCode indy_vdr_build_get_attrib_request(FfiStr submitter_did,
                                            FfiStr target_did, FfiStr raw,
                                            FfiStr hash, FfiStr enc,
                                            uintptr_t *handle_p);

ErrorCode indy_vdr_build_cred_def_request(FfiStr submitter_did, FfiStr cred_def,
                                          uintptr_t *handle_p);

ErrorCode indy_vdr_build_custom_request(FfiStr request_json,
                                        uintptr_t *handle_p);

ErrorCode
indy_vdr_build_disable_all_txn_author_agreements_request(FfiStr submitter_did,
                                                         uintptr_t *handle_p);
...
ErrorCode indy_vdr_build_get_nym_request(FfiStr submitter_did, FfiStr dest,
                                         uintptr_t *handle_p);
...
ErrorCode indy_vdr_build_get_txn_request(FfiStr submitter_did,
                                         int32_t ledger_type, int32_t seq_no,
                                         uintptr_t *handle_p);

ErrorCode indy_vdr_build_get_validator_info_request(FfiStr submitter_did,
                                                    uintptr_t *handle_p);

ErrorCode indy_vdr_build_nym_request(FfiStr submitter_did, FfiStr dest,
                                     FfiStr verkey, FfiStr alias, FfiStr role,
                                     uintptr_t *handle_p);
...
ErrorCode indy_vdr_build_schema_request(FfiStr submitter_did, FfiStr schema,
                                        uintptr_t *handle_p);

ErrorCode indy_vdr_build_txn_author_agreement_request(
    FfiStr submitter_did, FfiStr text, FfiStr version, int64_t ratification_ts,
    int64_t retirement_ts, uintptr_t *handle_p);

ErrorCode indy_vdr_build_rich_schema_request(FfiStr submitter_did, FfiStr rs_id,
                                             FfiStr rs_content, FfiStr rs_name,
                                             FfiStr rs_version, FfiStr rs_type,
                                             FfiStr ver, uintptr_t *handle_p);

ErrorCode indy_vdr_build_get_rich_schema_object_by_id_request(
    FfiStr submitter_did, FfiStr rs_id, uintptr_t *handle_p);

ErrorCode indy_vdr_build_get_rich_schema_object_by_metadata_request(
    FfiStr submitter_did, FfiStr rs_type, FfiStr rs_name, FfiStr rs_version,
    uintptr_t *handle_p);
...
ErrorCode indy_vdr_pool_submit_action(uintptr_t pool_handle,
                                      uintptr_t request_handle, FfiStr nodes,
                                      int32_t timeout,
                                      void (*cb)(uintptr_t cb_id, ErrorCode err,
                                                 const char *response),
                                      uintptr_t cb_id);

ErrorCode indy_vdr_pool_submit_request(
    uintptr_t pool_handle, uintptr_t request_handle,
    void (*cb)(uintptr_t cb_id, ErrorCode err, const char *response),
    uintptr_t cb_id);

ErrorCode indy_vdr_pool_close(uintptr_t pool_handle);

ErrorCode indy_vdr_prepare_txn_author_agreement_acceptance(
    FfiStr text, FfiStr version, FfiStr taa_digest, FfiStr acc_mech_type,
    uint64_t time, const char **output_p);

ErrorCode indy_vdr_request_free(uintptr_t request_handle);

ErrorCode indy_vdr_request_get_body(uintptr_t request_handle,
                                    const char **body_p);

ErrorCode indy_vdr_request_get_signature_input(uintptr_t request_handle,
                                               const char **input_p);

ErrorCode indy_vdr_request_set_endorser(uintptr_t request_handle,
                                        FfiStr endorser);
...
ErrorCode
indy_vdr_request_set_txn_author_agreement_acceptance(uintptr_t request_handle,
                                                     FfiStr acceptance);
